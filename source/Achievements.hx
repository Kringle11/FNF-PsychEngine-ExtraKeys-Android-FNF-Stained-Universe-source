...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Gems Down In Africa",         "Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["Safe... For Now",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			false],
		["Stain Deez Nuts",			    "Beat Week 3 on Hard with no Misses.",				'week3_nomiss',			false],
		...
		["you did this on purpose",	    "Complete a Song with a rating lower than 20%.",	'ur_bad',				false],
		["Average Funk Enjoyer",		"Complete a Song with a rating of 100%.",			'ur_good',				false],
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		var achievementName:FlxText = new FlxText(achievementIcon.x + achievementIcon.width + 20, achievementIcon.y + 6, 280, Achievements.achievementsStuff[id][0], 16);
		achievementName.setFormat(Paths.font("crewniverse_font.ttf"), 16, FlxColor.WHITE, LEFT);
		achievementName.scrollFactor.set();

		var achievementText:FlxText = new FlxText(achievementName.x, achievementName.y + 22, 280, Achievements.achievementsStuff[id][1], 16);
		achievementText.setFormat(Paths.font("crewniverse_font.ttf"), 16, FlxColor.WHITE, LEFT);
